            ...
            $content = '<div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm">
                    ...
                    <p class="text-slate-600 leading-relaxed">
                        By partnering with Warriors Educare for your ' . strtolower($s->title) . ' needs, you are choosing a trusted ally committed to excellence. We leverage our extensive network and deep industry knowledge to deliver unparalleled results. Let us help you take your institution to the next level.
                    </p>
                </div>
            </div>';
