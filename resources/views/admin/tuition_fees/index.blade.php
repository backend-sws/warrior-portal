...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h1 class="text-2xl font-black text-text-main">Payment Management</h1>
        <p class="text-text-dark/60 text-sm mt-1">Track tuition fees and payment collections.</p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-xl shadow-sm border border-card-border p-4 flex items-center gap-4 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-xs font-bold text-text-dark/50 uppercase tracking-wider mb-0.5">Collected This Month</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-card-border p-4 flex items-center gap-4 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-xs font-bold text-text-dark/50 uppercase tracking-wider mb-0.5">Total Overdue Amount</p>
            <h3 class="text-xl font-black text-text-main">₹{{ number_format($totalPendingAmount) }}</h3>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-card-border p-4 flex items-center gap-4 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-xs font-bold text-text-dark/50 uppercase tracking-wider mb-0.5">Overdue Accounts</p>
