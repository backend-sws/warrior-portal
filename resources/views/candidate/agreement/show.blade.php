...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (!hasDrawn) {
            e.preventDefault();
            alert('✍️ Digital Signature is MANDATORY!\nPlease draw your signature inside the signature box before submitting.');
            return;
        }
        ...
        if (!hasCaptured && !hasUploaded && !hasExistingPhoto) {
            e.preventDefault();
            alert('📸 Live Camera Photo Capture is MANDATORY!\n\nPlease click "Open Camera" and capture your selfie (or use "Upload Photo") before signing the agreement.');
            const badge = document.getElementById('cameraStatusBadge');
            if (badge) {
