...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex items-center gap-4 mb-8 reveal">
        @if($profile->profile_photo_path)
            <img src="{{ asset('storage/' . $profile->profile_photo_path) }}" alt="Profile Photo" class="w-16 h-16 rounded-full object-cover border-2 border-[#0ea5e9] shadow-lg">
        @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="{{ $user->name }}" disabled class="w-full bg-[#f4f7f5]/50 border border-[#031b4e]/10 rounded-xl pl-11 pr-4 py-3 text-sm text-[#031b4e]/60 cursor-not-allowed">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" value="{{ $user->email }}" disabled class="w-full bg-[#f4f7f5]/50 border border-[#031b4e]/10 rounded-xl pl-11 pr-4 py-3 text-sm text-[#031b4e]/60 cursor-not-allowed">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="{{ $user->phone }}" disabled class="w-full bg-[#f4f7f5]/50 border border-[#031b4e]/10 rounded-xl pl-11 pr-4 py-3 text-sm text-[#031b4e]/60 cursor-not-allowed">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="address" required rows="3" class="w-full bg-[#f4f7f5] border border-[#031b4e]/10 rounded-xl pl-11 pr-4 py-3 text-sm text-[#031b4e] focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/50 focus:border-[#0ea5e9] transition-all resize-none">{{ old('address', $profile->address) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
