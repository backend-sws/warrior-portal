...
<div class="relative pt-12 pb-12 lg:pt-24 lg:pb-24 px-6 lg:px-[5%] {{ $image ? 'bg-[#040e2d]' : 'bg-gradient-to-r from-[#040e2d] via-[#129aef] to-[#040e2d]' }} border-t border-white/10 overflow-hidden flex flex-col items-center justify-center text-center">
    @if($image)
        <div class="absolute inset-0 bg-cover bg-center opacity-30 z-0" style="background-image: url('{{ $image }}');"></div>
    @endif
