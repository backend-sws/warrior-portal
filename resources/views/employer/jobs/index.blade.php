...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
            <h1 class="text-2xl font-bold text-[#031b4e]">My Jobs</h1>
            <p class="text-sm text-[#031b4e]/70 mt-0.5">Manage your job postings and track their approval status.</p>
        </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-card-border">
                ...
                <tr class="hover:bg-white/30 transition-colors group">
                    <td class="py-4 px-6">
                        <div class="font-bold text-[#031b4e]">{{ $job->title }}</div>
                        <div class="text-xs text-[#031b4e]/60 mt-0.5"><i class="fas fa-map-marker-alt text-accent-yellow/70 mr-1"></i> {{ $job->city?->name ?? 'N/A' }}</div>
                    </td>
                    <td class="py-4 px-6">
                    ...
                    <td class="py-4 px-6 text-sm text-[#031b4e]/70">
                    ...
                    <td class="py-4 px-6 text-right">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            @endif
                            @if($job->status === 'approved')
                                <a href="{{ route('employer.applicants.index', ['job_post_id' => $job->id]) }}" class="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-[#031b4e]/70 hover:text-green-400 hover:bg-green-400/10 transition-colors" title="View Applicants">
                ...
                <tr>
                    <td colspan="5" class="py-16 text-center">
                        ...
                        <p class="text-[#031b4e] font-bold text-lg mb-1">No jobs posted yet</p>
                        <p class="text-[#031b4e]/40 text-sm mb-4">You haven't posted any jobs. Create your first job posting now.</p>
                        <a href="{{ route('employer.jobs.create') }}" class="inline-block px-6 py-2.5 bg-[#0ea5e9] hover:bg-[#0284c7] text-white rounded-xl text-sm font-semibold transition-colors">
                            Post a Job
                        </a>
                    </td>
                </tr>
