...
<div class="pt-32 pb-12 px-6 lg:px-[5%] text-center border-b border-card-border bg-card-bg/30">
    ...
    <p class="text-text-main opacity-70 max-w-2xl mx-auto">Stay updated with the latest trends in education recruitment and news from Warriors Educare.</p>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <article class="bg-card-bg border border-card-border rounded-2xl overflow-hidden shadow-lg hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 group reveal reveal-delay-1">
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-text-main mb-3 leading-tight group-hover:text-accent-blue transition-colors">Warriors Educare Agency Partners with 50+ New Schools</h3>
