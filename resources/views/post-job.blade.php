@extends('layouts.app')
@section('title', 'Post a Job Requirement — Warriors Educare')
                ...
                <div class="pt-4 border-t border-slate-100">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                                    Specialization <span class="text-xs text-slate-400 font-normal lowercase">(optional)</span>
                                </label>
                                <input type="text" name="specialization_name" value="{{ old('specialization_name') }}" 
                                    class="w-full bg-[#f8fafc] border border-slate-200 rounded-xl px-4 py-3.5 text-sm text-slate-800 focus:outline-none focus:border-[#129aef] focus:ring-2 focus:ring-[#129aef]/20 transition-all placeholder:text-slate-400 font-medium" 
                                    placeholder="e.g. Physics / Organic Chemistry / Admission Sales / Vedic Maths">
