...
@section('content')
    ...
    <div class="pt-32 pb-12 px-6 lg:px-[5%] text-center border-b border-card-border metallic-blue-card border-none shadow-none text-white">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6">Pricing & Service Charges Policy</h1>
    ...
    <div class="py-16 px-6 lg:px-[5%] max-w-4xl mx-auto">
        <div
            ...
            <p>By registering with Warriors Educare or using our services, you acknowledge that
        ...
        <p class="text-text-secondary leading-7 mb-4">
            Warriors Educare offers two registration options for candidates.
        </p>
        ...
        <p class="text-text-secondary leading-7 mb-4">
            Warriors Educare follows a "Pay After Successful Joining" model.
        </p>
        ...
        <ul class="list-disc pl-6 mb-4 space-y-2">
            ...
            <li class="text-text-secondary leading-7">The candidate has officially joined the institution through Warriors Educare
                Placement Agency.</li>
        ...
        <p class="text-text-secondary leading-7 mb-4">
            Warriors Educare reserves the right to revise or update its pricing structure, registration plans, or
