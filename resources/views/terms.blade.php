...
@section('content')
    <div class="pt-32 pb-12 px-6 lg:px-[5%] text-center border-b border-card-border metallic-blue-card border-none shadow-none text-white">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6">Terms & Conditions</h1>
        <p class="text-white opacity-70 max-w-2xl mx-auto">Last updated: July 2026</p>
    </div>
    ...
    <div class="py-16 px-6 lg:px-[5%] max-w-4xl mx-auto">
        <div
            ...
            <p class="mb-6 leading-relaxed">Welcome to Warriors Educare. These Terms and Conditions outline the
                Welcome to Warriors Educare (Owned By Aditya Rajveer). These Terms & Conditions ("Terms") govern
                your
            ...
            <h2 class="text-2xl font-bold text-text-main mt-8 mb-4">1. About Warriors Educare</h2>
            <p class="mb-6 leading-relaxed">Warriors Educare is an independent recruitment and placement consultancy
            ...
            <p class="mb-6 leading-relaxed">Warriors Educare reserves the right to verify any information provided.
                Submission
            ...
            <p class="mb-6 leading-relaxed">Warriors Educare may offer different registration plans, including
            ...
            <p class="mb-6 leading-relaxed">Warriors Educare evaluates candidate profiles and recommends suitable
            ...
            <ul class="list-disc pl-6 mb-6 text-text-main opacity-80 space-y-2">
                ...
                <li>Inform Warriors Educare immediately after accepting an offer or joining an
            ...
            <p>Warriors Educare is not responsible for salary disputes, employment conditions, or workplace issues
...
<h2 class="text-2xl font-bold text-text-main mt-8 mb-4">10. Intellectual Property</h2>
            <p>All content available on this website, including but not limited to logos, graphics, text,
                images, documents, trademarks, layouts, and branding, is the exclusive property of Warriors Educare
            ...
            <p class="text-text-secondary leading-7 mb-2">
                Warriors Educare reserves the right to suspend or terminate any account without prior notice if:
            </p>
            ...
            <p class="text-text-secondary leading-7">
                Email: warriorseducare@gmail.com
            </p>
            ...
            <p class="text-text-secondary leading-7">
                Website: www.warriorseducare.in
            </p>
