...
career with Warriors Educare
        ...
        <div class="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
            ...
            <form action="<?php echo e(route('candidate.register.post')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\warrior-portal\resources\views/auth/register_candidate.blade.php ENDPATH**/ ?>