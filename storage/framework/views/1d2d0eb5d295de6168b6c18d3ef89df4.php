...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Find Tuitions','breadcrumbs' => ['Home' => route('home'), 'Tuitions' => null],'image' => 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Find Tuitions','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Home' => route('home'), 'Tuitions' => null]),'image' => 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80']); ?>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between hover:border-accent-blue/50 hover:shadow-xl transition-all duration-300 group reveal">
            <div>
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="bg-blue-50 text-accent-blue px-3 py-1.5 rounded-full text-xs font-bold whitespace-nowrap"><?php echo e($tuition->board ?? 'N/A'); ?></span>
                </div>
                
                <h3 class="text-lg font-bold text-slate-900 mb-1 group-hover:text-accent-blue transition-colors line-clamp-1">
                    <?php echo e($tuition->subjects ?? 'Tuition Requirement'); ?>

                </h3>
                <p class="text-sm text-slate-500 font-medium mb-3 line-clamp-1"><?php echo e($tuition->location); ?></p>
                
                <p class="text-sm text-slate-600 leading-relaxed mb-5 line-clamp-3">
                    Class: <?php echo e($tuition->class); ?> <br>
                    Timing: <?php echo e($tuition->preferred_timing ?? 'Not specified'); ?>
            ...
            <div>
                <div class="flex justify-between items-center border-t border-slate-100 pt-4">
                    <div class="flex flex-col">
                        <span class="text-[10px] text-slate-400 font-medium mt-1">Posted <?php echo e($tuition->created_at->diffForHumans()); ?></span>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sticky top-24">
            ...
            <?php if(session('tuition_success')): ?>
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6 text-sm" role="alert">
                    <span class="block sm:inline"><?php echo e(session('tuition_success')); ?></span>
                </div>
            <?php endif; ?>

            <form action="<?php echo e(route('tuition.post')); ?>" method="POST" class="flex flex-col gap-5">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\warrior-portal\resources\views/tuitions.blade.php ENDPATH**/ ?>