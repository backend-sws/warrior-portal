...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-secondary-bg relative overflow-hidden">
    ...
    <div class="max-w-md w-full text-center relative z-10">
        ...
        <p class="text-text-dark/70 mb-8 max-w-sm mx-auto">
            <?php echo e($exception->getMessage() ?: 'You do not have permission to access this page. If you believe this is an error, please contact support.'); ?>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 bg-accent-blue text-white px-6 py-3.5 rounded-xl font-semibold shadow-glow-blue hover:bg-accent-blue-hover transition-all hover:-translate-y-0.5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\warrior-portal\resources\views/errors/403.blade.php ENDPATH**/ ?>