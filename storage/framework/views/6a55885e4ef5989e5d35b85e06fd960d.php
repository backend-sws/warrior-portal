    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-card-bg rounded-2xl border border-card-border shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <form action="<?php echo e(route('admin.tuition-leads.invoice.store', $lead->id)); ?>" method="POST" class="bg-secondary-bg/30 p-4 rounded-xl border border-card-border" onsubmit="this.querySelector('button[type=submit]').disabled=true; this.querySelector('button[type=submit]').innerHTML='<i class=\'fas fa-spinner fa-spin\'></i> Sending...';">
                    <?php echo csrf_field(); ?>
