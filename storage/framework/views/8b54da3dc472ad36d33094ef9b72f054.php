                    ...
                    <form action="<?php echo e(route('admin.crm.invoice.store', $candidate->id)); ?>" method="POST" class="flex flex-wrap gap-4 items-end">
                        ...
                        <div class="w-full md:w-auto flex-1">
                            ...
                            <select name="job_application_id" id="job_application_id" class="w-full rounded-lg border-gray-300 shadow-sm text-sm py-2.5 px-3 focus:ring-blue-500 focus:border-blue-500" required>
                                ...
                                <?php $__currentLoopData = $candidate->applications->where('status', '!=', 'rejected'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($app->id); ?>"><?php echo e($app->jobPost->title); ?> (<?php echo e($app->jobPost->school_name); ?>) - <?php echo e(ucfirst($app->status)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="w-24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\warrior-portal\resources\views/admin/crm/show.blade.php ENDPATH**/ ?>