    ...
    <div class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden reveal">
        ...
        <div class="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
            ...
            <div class="mb-8 grid grid-cols-1 gap-4 relative z-20">
                <a href="<?php echo e(route('parent.register')); ?>"
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-bold text-[#1e3a8a] hover:underline transition-colors">Forgot password?</a>
                </div>
                ...
                <div class="mt-4 text-center">
                    <a href="<?php echo e(route('login.otp')); ?>" class="w-full bg-white text-gray-900 border border-gray-200 font-bold py-3.5 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1e3a8a] transition-all shadow-sm hover:-translate-y-0.5 flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\warriors portal\warriors portal\resources\views/auth/login.blade.php ENDPATH**/ ?>