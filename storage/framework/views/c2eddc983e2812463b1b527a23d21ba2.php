    ...
    <div x-data="{ showWelcomeModal: false }" 
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-5xl w-[90%] mx-4 relative overflow-hidden" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 pb-4">
                <!-- Card 1: Parents -->
                <a href="<?php echo e(route('parent.register')); ?>" class="group relative rounded-2xl p-8 text-center transition-all duration-300 shadow-sm hover:shadow-2xl hover:-translate-y-2 border border-slate-100 hover:border-[#031b4e] overflow-hidden isolate">
                ...
                <!-- Card 3: Candidates -->
                <a href="<?php echo e(route('candidate.register')); ?>" class="group relative rounded-2xl p-8 text-center transition-all duration-300 shadow-sm hover:shadow-2xl hover:-translate-y-2 border border-slate-100 hover:border-[#031b4e] overflow-hidden isolate">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 relative z-10">
                ...
                <a href="<?php echo e(route('category.jobs', $category->id)); ?>"
                    ...
                    <div class="category-inner">
                        ...
                        <div class="relative z-10">
                            <h3 class="text-white text-[17px] font-semibold tracking-wide mb-1 leading-tight"><?php echo e($category->name); ?></h3>
        ...
        <section class="py-24 bg-[#f4f7f5] relative overflow-hidden font-sans">
            ...
            <div class="container mx-auto max-w-[1000px] px-6 relative z-10">
                ...
                <div class="neu-card p-8 lg:p-14 flex flex-col lg:flex-row gap-12 lg:gap-16 relative overflow-hidden group">
                    ...
                    <div class="absolute inset-0 z-0 opacity-5 pointer-events-none animate-pattern-move" style="background-image: url('<?php echo e(asset('images/network-pattern.svg')); ?>'); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
