        ...
        <nav class="hidden lg:flex items-center gap-4 xl:gap-6">
            <ul class="flex gap-3 lg:gap-4 xl:gap-6 list-none m-0 p-0">
                ...
                <li><a href="<?php echo e(route('tuitions')); ?>"
                        class="<?php echo e(request()->routeIs('tuitions') ? 'text-white font-bold' : 'text-gray-200 hover:text-white'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">Tuitions</a>
                </li>
    ...
    <div id="mobileMenu"
        ...
        <div class="flex-grow overflow-y-auto p-6 flex flex-col gap-6">
            <ul class="flex flex-col gap-5 text-lg font-semibold">
                ...
                <li><a href="<?php echo e(route('tuitions')); ?>"
                        class="<?php echo e(request()->routeIs('tuitions') ? 'text-accent-blue' : 'text-text-main hover:text-accent-blue'); ?> transition-colors">Tuitions</a>
                </li>
                <li><a href="<?php echo e(route('resume.builder')); ?>"
