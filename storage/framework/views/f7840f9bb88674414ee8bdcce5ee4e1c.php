        ...
        <nav class="hidden lg:flex items-center gap-4 xl:gap-6">
            <ul class="flex gap-3 lg:gap-4 xl:gap-6 list-none m-0 p-0">
                <li><a href="<?php echo e(route('home')); ?>"
                        class="<?php echo e(request()->routeIs('home') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">Home</a>
                </li>
                <li><a href="<?php echo e(route('about')); ?>"
                        class="<?php echo e(request()->routeIs('about') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">About us</a></li>
                <li><a href="<?php echo e(route('services')); ?>"
                        class="<?php echo e(request()->routeIs('services') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">Services</a></li>
                <li><a href="<?php echo e(route('jobs')); ?>"
                        class="<?php echo e(request()->routeIs('jobs') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">Jobs</a>
                </li>
                <li><a href="<?php echo e(route('tuitions')); ?>"
                        class="<?php echo e(request()->routeIs('tuitions') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[14px] lg:text-[15px] transition-colors">Tuitions</a>
                </li>
                <li><a href="<?php echo e(route('resume.builder')); ?>"
                        class="<?php echo e(request()->routeIs('resume.builder') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[15px] transition-colors">Resume Builder <span
                ...
                <li><a href="<?php echo e(route('contact')); ?>"
                        class="<?php echo e(request()->routeIs('contact') ? 'text-[#031b4e] font-bold' : 'text-gray-600 hover:text-[#031b4e]'); ?> whitespace-nowrap font-medium text-[15px] transition-colors">Contact</a></li>
            </ul>
            <div class="flex gap-3 lg:gap-4 items-center">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" style="display: none;" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-100 z-50 overflow-hidden text-gray-800">
                            <div class="p-3 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                                ...
                                <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                                    <span class="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-bold"><?php echo e(auth()->user()->unreadNotifications->count()); ?> New</span>
                                <?php endif; ?>
                            </div>
                            <div class="max-h-80 overflow-y-auto">
                                <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="p-3 border-b border-gray-50 hover:bg-gray-50 transition-colors <?php echo e(is_null($notification->read_at) ? 'bg-blue-50/30' : ''); ?>">
                                        <div class="flex gap-3">
                                            ...
                                            <div>
                                                <h4 class="text-sm font-semibold text-gray-900"><?php echo e($notification->data['title'] ?? 'Notification'); ?></h4>
                                                <p class="text-xs text-gray-600 mt-0.5 line-clamp-2"><?php echo e($notification->data['message'] ?? ''); ?></p>
                                                <span class="text-[10px] text-gray-400 mt-1 block"><?php echo e($notification->created_at->diffForHumans()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <a href="<?php echo e(auth()->user()->role === 'candidate' ? route('candidate.dashboard') : (auth()->user()->role === 'parent' ? route('parent.dashboard') : route('admin.dashboard'))); ?>"
    ...
    <div id="mobileMenu"
        ...
        <div class="flex-grow overflow-y-auto p-6 flex flex-col gap-6">
            <ul class="flex flex-col gap-5 text-lg font-semibold">
                <li><a href="<?php echo e(route('home')); ?>"
                        class="<?php echo e(request()->routeIs('home') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Home</a>
                </li>
                <li><a href="<?php echo e(route('about')); ?>"
                        class="<?php echo e(request()->routeIs('about') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">About
                        us</a></li>
                <li><a href="<?php echo e(route('services')); ?>"
                        class="<?php echo e(request()->routeIs('services') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Our
                        Services</a></li>
                <li><a href="<?php echo e(route('jobs')); ?>"
                        class="<?php echo e(request()->routeIs('jobs') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Jobs</a>
                </li>
                <li><a href="<?php echo e(route('tuitions')); ?>"
                        class="<?php echo e(request()->routeIs('tuitions') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Tuitions</a>
                </li>
                <li><a href="<?php echo e(route('resume.builder')); ?>"
                        class="<?php echo e(request()->routeIs('resume.builder') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Resume
                        Builder <span
                ...
                <li><a href="<?php echo e(route('hiring')); ?>"
                        class="<?php echo e(request()->routeIs('hiring') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Hiring
                        Process</a></li>
                <li><a href="<?php echo e(route('contact')); ?>"
                        class="<?php echo e(request()->routeIs('contact') ? 'text-[#fbc043]' : 'text-white/80 hover:text-white'); ?> transition-colors">Contact
                        us</a></li>
            </ul>
